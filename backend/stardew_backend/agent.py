...
class StardewAgent:
    ...
    def _build_messages(
        ...
        system = (
            ...
            "For farm-help and mine-expedition requests, you may only accept, refuse, or negotiate through action_proposal. "
        ...
        prompt = (
            ...
            "    \"action\": \"water_crops|clear_weeds|chop_trees|join_mine_expedition|defend_player|mine_target|mine_nearby|mine_expedition\",\n"
            "    \"disposition\": \"accept|refuse|negotiate\",\n"
            "    \"parameters\": {\"max_targets\": 10, \"resource_priority\": \"any|stone|copper|iron|gold|iridium\"},\n"
            "    \"confidence\": 0.0,\n"
